...
require 'doorkeeper/oauth/authorization/device_code'
...
require 'doorkeeper/oauth/pre_authorization_mixin'
require 'doorkeeper/oauth/pre_authorization'
require 'doorkeeper/oauth/device_pre_authorization'
...
require 'doorkeeper/oauth/device_code_request'
require 'doorkeeper/oauth/device_token_request'
require 'doorkeeper/oauth/client'
require 'doorkeeper/oauth/token'
require 'doorkeeper/oauth/invalid_token_response'
require 'doorkeeper/oauth/forbidden_token_response'
require 'doorkeeper/oauth/device_code_response'
